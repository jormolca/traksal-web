...
export const metadata = {
  title: 'Gestión Centralizada de Solicitudes para Managers | Traksal',
  description: 'Controla todas las peticiones de vacaciones, libranzas y correcciones de fichaje de tu equipo desde un único panel centralizado. Ahorra tiempo y aprueba en un clic.',
  keywords: ['gestión de solicitudes', 'aprobar ausencias', 'panel recursos humanos', 'revisar fichajes', 'traksal'],
  alternates: {
    canonical: 'https://www.traksal.com/gestion-de-solicitudes',
    languages: { 'es': 'https://www.traksal.com/gestion-de-solicitudes', 'en': 'https://www.traksal.com/en/request-management' }
  },
  openGraph: {
    title: 'Gestión Centralizada de Solicitudes | Traksal',
    description: 'Controla todas las peticiones de tu equipo en un único panel.',
    url: 'https://www.traksal.com/gestion-de-solicitudes',
    type: 'website',
  }
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Traksal Panel de Managers",
            "operatingSystem": "Web",
            "applicationCategory": "BusinessApplication",
            "featureList": [
              "Panel centralizado para responsables",
              "Aprobación de vacaciones y libranzas",
              "Gestión de correcciones de fichaje",
      ...
      <section style={{
        ...
        <div className="container">
          <div className="responsive-grid" style={{ position: 'relative' }}>
            ...
            {/* Text Side */}
            <div style={{ order: 1 }}>
              <span className="section-label">Para Responsables</span>
              ...
              <p style={{ fontSize: '1.2rem', color: 'var(--text-secondary)', marginBottom: '40px', maxWidth: '500px', lineHeight: 1.6 }}>
                El panel de control definitivo para mánagers. Visualiza, revisa y responde a todas las peticiones de tus empleados sin salir de la plataforma.
              </p>
              ...
              <div style={{ display: 'grid', gap: '24px' }}>
                <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '1.1rem', marginBottom: '4px', color: 'white' }}>Bandeja de entrada unificada</h3>
                    <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}>Desde una sola pantalla puedes ver quién ha solicitado vacaciones, quién pide una libranza o quién necesita corregir un olvido en el fichaje.</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '1.1rem', marginBottom: '4px', color: 'white' }}>Resolución en 1 clic</h3>
                    <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}>No pierdas tiempo respondiendo correos. Aprueba o deniega cualquier petición de forma instantánea, manteniendo el historial siempre limpio.</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '1.1rem', marginBottom: '4px', color: 'white' }}>Registro e Historial</h3>
                    <p style={{ fontSize: '0.95rem', color: 'var(--text-secondary)' }}>Toda decisión queda guardada en el sistema para que tengas un registro auditable de las horas corregidas y las vacaciones aprobadas mes a mes.</p>
                  </div>
                </div>
              </div>
            ...
            <div style={{ order: 2, display: 'flex', justifyContent: 'center', position: 'sticky', top: '140px', alignSelf: 'start' }}>
               <div style={{ 
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Mis Tareas como Manager</div>
                  </div>

                  <div style={{ display: 'flex', gap: '8px', marginBottom: '16px', borderBottom: '1px solid var(--border-light)', paddingBottom: '12px' }}>
                    <span style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-primary)', borderBottom: '2px solid var(--secondary)', paddingBottom: '10px' }}>Bandeja de Revisión</span>
                    <span style={{ background: '#E74C3C', color: 'white', fontSize: '0.65rem', padding: '2px 6px', borderRadius: '10px', fontWeight: 800 }}>2</span>
                  </div>

                  {[
                    { name: 'Javier Ruíz', type: 'Corrección Fichaje', details: 'Fichaje de salida olvidado a las 18:00h', date: 'Ayer' },
                    { name: 'Elena García', type: 'Vacaciones', details: 'Del 22/12/2026 al 02/01/2027', date: 'Hace 2 horas' }
                  ].map((req, i) => (
